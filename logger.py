...
class LogColors:
    ...
    B_CYAN = "\033[0;96m"
    B_WHITE = "\033[0;97m"
    KHAKI_MILITARY = "\033[38;2;130;145;55m"
    CHERRY = "\033[38;2;180;30;60m"
    ...
    FILE_COLORS = {
        ...
        "lp_iteration_point_selector.py": CHERRY
    }
...
class ProfessionalFormatter(logging.Formatter):
    ...
    def format(self, record):
        ...
        if "\n" in msg:
            ...
            if lines:
                # Düzeltme: 'lines' bir liste olduğu için ilk elemanını almalıyız
...
if not LOGGER.hasHandlers():
    log_filename = os.path.join(LOGS_DIR, "simulation.log")

    with open(log_filename, "w", encoding="utf-8") as f:
        header_date = datetime.now().strftime("%d.%m.%Y %H:%M")
